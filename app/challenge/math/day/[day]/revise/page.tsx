// app/challenge/math/day/[day]/revise/page.tsx
...
export default function ReviseConceptPage() {
  return (
    <main className="min-h-screen bg-background text-light p-4 flex flex-col">
      ...
      <h1 className="text-2xl font-bold text-primary mb-2">Day 5: Multiply by 11 Trick</h1>
      ...
      <section className="bg-dark p-4 rounded-xl shadow-md mb-6">
        ...
        <p className="text-sm mt-3 text-green-400">Example: 52 × 11 = 5<span className="underline">+5+2</span>2 = 572</p>
      </section>
